...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="row-mt-4">
        ...
        <h3>Sistem Database Online Kemahasiswaan Prodi</h3>
            ...
            <tbody>
                ...
                <td><?= $mhs["jurusan"];?></td>              
                <td><?= $mhs["email"];?></td>
                <td><a href="<?= base_url();?>admin/mahasiswa/detail/<?= $mhs['nim'];?>"
                class="btn btn-primary btn-sm float-right fas fa-question-circle ml-2 mr-2"> Detail</a></td>
                <td><a href="<?=base_url();?>admin/mahasiswa/hapus/<?=$mhs['nim'];?>"
                ...
                <td><a href="<?= base_url();?>admin/mahasiswa/edit/<?= $mhs['nim'];?>"
    ...
    <!--a href="<?php echo base_url('admin/mahasiswa/laporanmahasiswa_pdf') ?>"
