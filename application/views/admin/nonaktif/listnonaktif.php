    ...
    <div class="row-mt-4">
        ...
        <h3>Sistem Database Online Kemahasiswaan JTD</h3>
            ...
            <tr>
                ...
                <td><?= $mn["kelas"];?></td>
                <td><?= $mn["keterangan"];?></td>
                <td><a href="<?= base_url();?>admin/nonaktif/detail/<?= $mn['nim'];?>"
                class="btn btn-primary btn-sm float-right fas fa-question-circle ml-2 mr-2"> Detail</a></td>
                <td><a href="<?=base_url();?>admin/nonaktif/hapus/<?=$mn['nim'];?>"
                ...
                <td><a href="<?= base_url();?>admin/nonaktif/edit/<?= $mn['nim'];?>"
