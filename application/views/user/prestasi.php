...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="row-mt-4">
        ...
        <h3>Sistem Database Online Mahasiswa</h3>
            ...
            <tbody>
                ...
                <!--td><a href="<?= base_url();?>user/prestasi/detail/<?= $prestasi['nim'];?>"
                class="btn btn-primary btn-sm float-right fas fa-question-circle ml-2 mr-2"> Detail</a></td>
                <td><a href="<?=base_url();?>user/prestasi/hapus/<?=$prestasi['nim'];?>"
                ...
                <td><a href="<?= base_url();?>user/prestasi/edit/<?= $prestasi['nim'];?>"
    ...
    <a href="<?php echo base_url('user/prestasi/laporanprestasi_pdf') ?>"
